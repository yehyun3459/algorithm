...
//원문 test data : https://gcpc.nwerc.eu/german-collegiate-programming-contest-2011
...
bool DFS(int cnt)
{
	if(cnt==5)
	{
		if (board[1][7] + board[1][5] + board[1][3] + board[1][1] != 26)return false;
	}
	if(cnt==8)
	{
	...
	if(cnt==11)
	{
		...
		if (board[3][7] + board[2][6] + board[1][5] + board[0][4] != 26)return false;
	}
	if(cnt>=12)
	{
		if(board[1][1] + board[2][2] + board[3][3] + board[4][4] == 26 &&
